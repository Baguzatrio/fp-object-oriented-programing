...
public class DataCustomer extends javax.swing.JFrame {
    ...
    public JTextField getTextField3() { return jTextField3; }
    public JTextField getTextField4() { return jTextField4; }
...
public JScrollPane getTableScrollPane() {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                User user = new User("admin", "joe");
            DataCustomerModel model = new DataCustomerModel();
            DataCustomer view = new DataCustomer();
            DataCustomerController controller = new DataCustomerController(model, view, user);

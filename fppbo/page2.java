...
public class page2 extends javax.swing.JFrame {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (nama.isEmpty() || username.isEmpty() || password.isEmpty() || confirmPassword.isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(this, "Semua harus diisi!", "Error", javax.swing.JOptionPane.ERROR_MESSAGE);
            return;
        }
        try (java.sql.Connection conn = DatabaseConnection.getConnection()) {
           ...
           try (java.sql.PreparedStatement stmt = conn.prepareStatement(sql)) {
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Gagal Sign Up: " + ex.getMessage());
        }
